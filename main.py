...
MODEL = tf.keras.models.load_model("fruit_models/1")
#endpoint = "http://localhost:8501/v1/models/potatoes_model:predict"
CLASS_NAMES=["Apple","Apricot","Avocado","Banana","Blueberry","Cactus fruit","Cherry","Chestnut","Coconut","Corn","Dates","Dragon Fruit","Fig","Grape","Grape Blue","Green Capsicum","Guava","Hazelnut","Huckleberry","Kiwi","Lemon","Lychee","Mandarine","Mango","Mango Red","Mulberry","Orange","Papaya","Passion Fruit","Peach","Pear","Pineapple","Plum","Pomegranate","Quince","Raspberry","Redcurrant","Star fruit","Strawberry","Tangerine","Tomato","Tomato not Ripened","Walnut","Watermelon"]
# CLASS_NAMES = ["Tomato Target Spot", "Tomato Tomato mosaic virus","Tomato Tomato_YellowLeaf Curl_Virus" ,"Tomato Bacterial spot","Tomato_Early_blight","Healthy","Tomato Late blight","Tomato Leaf Mold","Tomato Septoria leaf spot","Tomato_Spider mites Two spotted spider mite"]
